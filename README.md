...
Below, Section 1 is only for those with a GPU; skip if you don't have one in your system and complete steps 2 through 5. The remaining sections 6 through 9 are optinal. The Conclusion is simply to remind you of the ways you can invoke your new virtual Python ML setup.
